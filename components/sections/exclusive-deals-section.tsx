                  ...
                  <div className="absolute bottom-6 left-6 right-6 text-white">
                    ...
                    {deal.date && (
                      <div className="flex items-center gap-2 my-4">
                        ...
                        <span className="text-sm font-gilroy font-medium text-white">{deal.date}</span>
                      </div>
                    )}
                    ...
                    {deal.dates && (
                      <div className="flex items-center gap-2 my-4">
                        ...
                        <span className="text-sm font-gilroy font-medium text-white">{deal.dates}</span>
                      </div>
                    )}
                        ...
                        <span className="line-through font-gilroy font-medium text-lg" style={{ color: '#E6E2C3' }}>
                          ₹{deal.originalPrice.toLocaleString()}
                        </span>
                        <span className="font-gilroy font-medium text-sm" style={{ color: '#E6E2C3' }}>Per Person</span>
                      </div>
