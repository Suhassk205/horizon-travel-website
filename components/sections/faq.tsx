    ...
    <section className="py-20 bg-gray-50 relative">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-semibold text-[#16242A] mb-2 tracking-[-0.02em] leading-[64px]">
            Frequently Asked Questions
          </h2>
          <p className="text-lg font-medium text-[#293A3E] max-w-3xl mx-auto leading-[32px]">
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <span className="text-lg font-semibold text-[#16242A] tracking-[-0.02em] leading-[22px]">
                    {item.question}
                  </span>
