            ...
            <div className="mt-4 flex flex-wrap gap-4">
              <div className="flex items-center space-x-2 bg-[#29383E] px-4 py-2 rounded-lg">
                <Checkbox
                  ...
                  onCheckedChange={setRegularFares}
                  className="border-white data-[state=checked]:bg-white data-[state=checked]:text-[#29383E]"
                />
              ...
              <div className="flex items-center space-x-2 bg-[#29383E] px-4 py-2 rounded-lg">
                <Checkbox
                  ...
                  onCheckedChange={setArmedForcesFares}
                  className="border-white data-[state=checked]:bg-white data-[state=checked]:text-[#29383E]"
                />
              ...
              <div className="flex items-center space-x-2 bg-[#29383E] px-4 py-2 rounded-lg">
                <Checkbox
                  ...
                  onCheckedChange={setStudentFares}
                  className="border-white data-[state=checked]:bg-white data-[state=checked]:text-[#29383E]"
                />
              ...
              <div className="flex items-center space-x-2 bg-[#29383E] px-4 py-2 rounded-lg">
                <Checkbox
                  ...
                  onCheckedChange={setSeniorCitizenFares}
                  className="border-white data-[state=checked]:bg-white data-[state=checked]:text-[#29383E]"
                />
              ...
              <div className="flex items-center space-x-2 bg-[#29383E] px-4 py-2 rounded-lg">
                <Checkbox
                  ...
                  onCheckedChange={setDoctorNursesFares}
                  className="border-white data-[state=checked]:bg-white data-[state=checked]:text-[#29383E]"
                />
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col items-center justify-center px-6 py-20">
            ...
            <div className="w-full flex justify-center items-center" style={{ height: '400px' }}>
              <h1
                className={`text-white font-['Gilroy-Bold'] text-[400px] leading-none transition-opacity duration-500 ${
            ...
            <div className="flex flex-col w-full max-w-6xl">
              ...
              <div className="flex gap-1 overflow-x-auto">
                {/* Packages */}
                <div
                  className="flex items-center justify-center cursor-pointer hover:opacity-80 transition-all duration-200"
                  onClick={() => {
                    router.push("/packages")
                  }}
                  style={{
